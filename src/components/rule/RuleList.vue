    ...
    <div>
        <v-layout row wrap>
            ...
            <v-flex text-sm-right>
                <v-tooltip bottom>
                    <v-btn @click="addRule" slot="activator" color="info" right>
                        Add Rule
                    </v-btn>
...
export default {
    ...
    data: function () {
        return {
            ...
            tableList: {
                headers: [
                    { text: 'Source Environment', value: 'source_env_name', width:"25%", option:[], 'item_text':'name', 'item_value':'name'},
                    { text: 'Target Environment', value: 'target_env_name', width:"25%",option:[], 'item_text':'name', 'item_value':'name'}, 
                    { text: 'Workflow for Publish', value: 'publish_workflow_name', width:"25%", option:[], 'item_text':'workflow_name', 'item_value':'workflow_name' },
