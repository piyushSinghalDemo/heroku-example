...
<script>
	...
	import {GET_ALL_ACTIVE_USERS_LIST, WORKFLOW_TEMPLATE_LIST, GET_WORKFLOW_TEMPLATE_DETAILS, UPDATE_WORKFLOW_TEMPLATE, MANAGE_WORKFLOW_TEMPLATE} from '../../data/url_constants.js'
	  ...
	  data () {
		...
		methods: {
			...
			addworkflowRoute(){
				...
				var add_workflow_template_end_point = config.PROCESS_APPROVAL_URL + MANAGE_WORKFLOW_TEMPLATE
				postToServer(this, add_workflow_template_end_point, workflow_data).then(
					addResponse  => {
