		...
		<v-flex xs12>
		  	<v-card>
				...
				<div style="float:left;margin-top:7px;">
					<span style="color:rgba(0,0,0,0.54);font-weight:400;font-size:13px;"> Home /</span> &nbsp;<span style="font-weight:400;font-size:15px;">Workflow</span>
					</div>
            ...
            <span>Copy</span>
						...
						<router-link :to="{ name: 'editWorkflowRoute', params: { workflow_id: props.item.id}}">
							<v-tooltip bottom>
